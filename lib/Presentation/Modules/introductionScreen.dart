            ...
            children: [
              Container(
                ...
                child: SizedBox(
                  ...
                  child: Center(child: Image.asset(introImage)),
                ),
              ),
              SizedBox(
                height: 2.5.h,
          ...
          children: [
            ...
            Container(
              child: SmoothPageIndicator(
                controller: controller,
                count: pages.length,
                effect: ExpandingDotsEffect(dotHeight: 7.5, dotWidth: 10, activeDotColor: Colors.green.shade300, dotColor: Colors.grey[300]!),
              ),
            ),
            SizedBox(
              height: 1.h,
